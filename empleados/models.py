...
class Empleado(SoftDeleteModel):
    ...
    curp = models.CharField(max_length=18, unique=True, validators=[MinLengthValidator(18), curp_validator])
    rfc = models.CharField(max_length=13, unique=True, validators=[MinLengthValidator(12), rfc_validator])
