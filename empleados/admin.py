...
class EmpleadoAdmin(SimpleHistoryAdmin):
    list_display = (
        'id', 'num_empleado', 'apellido_paterno', 'apellido_materno', 'nombres',
        'departamento', 'puesto', 'activo', 'deleted_at'
    )
    list_filter = ('departamento', 'puesto', 'activo', 'genero', 'estado_civil')
    search_fields = ('num_empleado', 'nombres', 'apellido_paterno', 'apellido_materno', 'email', 'curp', 'rfc', 'nss')
