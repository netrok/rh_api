...
- [Configuración rápida (Windows 11)](#configuración-rápida-windows-11)
- [Base de datos (PostgreSQL 17)](#base-de-datos-postgresql-17)
- [Variables de entorno](#variables-de-entorno)
- [Comandos clave](#comandos-clave)
- [Documentación y Auth](#documentación-y-auth)
- [Endpoints principales](#endpoints-principales)
- [Filtros y ejemplos prácticos](#filtros-y-ejemplos-prácticos)
- [Soft delete & Auditoría](#soft-delete--auditoría)
- [Exportación a Excel](#exportación-a-excel)
- [Admin de Django](#admin-de-django)
- [Producción (seguridad y estáticos)](#producción-seguridad-y-estáticos)
...
rh_api/
 rh_api/
  settings.py # settings pulidos (CORS/CSRF, JWT, DRF, seguridad prod)
 ...
 catalogos/
  ...
  admin.py # Admin con acciones (soft delete / restore / hard delete)
 empleados/
  models.py # Empleado (FKs a catálogos, soft delete + history)
  serializers.py
  views.py # ViewSet con filtros, export-excel, history, restore, soft-delete
  admin.py
 media/ # uploads (imagenes de empleados)
...
`powershell
# 1) Clonar el repo (ajusta la URL)
cd C:\Proyectos
git clone <URL_DE_TU_REPO> rh_api
cd .\rh_api
